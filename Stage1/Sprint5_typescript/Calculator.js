...
function resetForm() {
    var minValueDisable = document.getElementById('minValue');
    var maxValueDisable = document.getElementById('maxValue');
    ...
    table.innerHTML = "";
    table2.innerHTML = "";
    var minValue = document.forms["myForm"]["minValue"];
    var maxValue = document.forms["myForm"]["maxValue"];
    var myNumber = document.forms["myForm"]["myNumber"];
    var meanValue = document.getElementById("meanValue");
    var medianValue = document.getElementById("medianValue");
...
function calcValues() {
    ...
    var minValueDisable = document.getElementById('minValue').disabled = true;
    var maxValueDisable = document.getElementById('maxValue').disabled = true;
    //minValueDisable.disabled = true;
    //maxValueDisable.disabled = true;
    var minValue = 0;
    var maxValue = 0;
