...
function getLocations() {
    return __awaiter(this, void 0, void 0, function () {
        var apiString, response, series, titles, episodes, jsonData, i, i, jsonData;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    apiString = "http://stapi.co/api/v1/rest/season/search";
                ...
                case 2:
                    ...
                    for (i = 0; i < jsonData.seasons.length; i++) {
...
function getNumberEpisodes() {
    return __awaiter(this, void 0, void 0, function () {
        var apiString, response, mySeries, jsonData, i, jsonData;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    apiString = "http://stapi.co/api/v1/rest/season/search";
                ...
                case 1:
                    response = _a.sent();
                    mySeries = document.getElementById("MySelect").value;
                    // clear the old data
                    document.getElementById("myEpisodes").innerHTML = "";
                    if (!(response.status >= 200 && response.status <= 299)) return [3 /*break*/, 3];
                    return [4 /*yield*/, response.json()];
