...
let slideIndex = 1;
let albumIndex = 1;
const titles = ["Brothers in Arms.jpg",
    "The Very Best of Fleetwood Mac",
    "Dark Side of the Moon"];
const bands = ["Dire Straits",
    "Fleetwood Mac",
    "Pink Floyd"];
const myUrl = ["https://upload.wikimedia.org/wikipedia/en/6/67/DS_Brothers_in_Arms.jpg",
